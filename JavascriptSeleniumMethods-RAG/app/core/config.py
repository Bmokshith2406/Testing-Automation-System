...
class Settings:
    APP_NAME: str = "Intelligent Script Methods (MongoDB Edition for Selenium Javascript Only)"
    VERSION: str = "1.0.0"
    ...
    DB_NAME: str = "javascript_selenium_script_methods_db"
    ...
    JWT_ACCESS_TOKEN_EXPIRE_MINUTES: int = 60 * 8  # 8 hours
        ...
        # ------------------------------------------------------------------
    # LLM Prompt Templates — JavaScript Selenium
    # ------------------------------------------------------------------

    Method_MADL_Prompt = """
    Analyze this raw Selenium JavaScript (WebDriver) method and return STRICT JSON only with this schema:
    ...
    {{
      ...
      "method_documentation": {{
        ...
        "returns": "",
        "keywords": [],
        "owner": "QE-Core/JavaScript Automation",
        "example_usage": "",
        "created": "",
        "last_updated": ""
      }}
    ...
    - method_name must contain full JavaScript function signature.
    - params must match JavaScript function parameters.
    - returns must be "Promise<void>" if nothing is returned.
    - keywords must relate to Selenium WebDriver, JavaScript, Node.js automation, browser testing.
    ...
    This is a query that I have received from a user for Selenium JavaScript automation method searching.
    ...
    paraphrases and synonyms for Selenium JavaScript automation method search.
    ...
    Your task:
    Re-rank the following Selenium JavaScript automation methods based on how well each one matches the given query.
    ...
    Look at these Selenium JavaScript automation methods and choose the {top_k} that best match what the user really wants to automate.
    ...
    Analyze the following Selenium JavaScript method.
    ...
    You are an expert Selenium JavaScript automation method duplication detector.
