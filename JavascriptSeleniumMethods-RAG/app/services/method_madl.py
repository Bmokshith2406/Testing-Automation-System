...
async def get_method_madl(raw_method: str) -> Dict[str, Any]:
    """
    Converts raw Selenium *JavaScript* method → MADL JSON.
    ...
    fallback_madl = {
        ...
        "method_documentation": {
            "summary": "Selenium JavaScript utility automation method.",
            "description": "Generic helper function used in Selenium WebDriverJS workflows.",
            "reusable": True,
