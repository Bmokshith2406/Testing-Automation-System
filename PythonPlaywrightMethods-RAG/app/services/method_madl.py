...
async def get_method_madl(raw_method: str) -> Dict[str, Any]:
    """
    Converts raw Playwright Python method → MADL JSON.
    """
    ...
    fallback_madl = {
        ...
        "method_documentation": {
            "summary": "Playwright automation utility method.",
            "description": "Generic helper function used in Playwright-based workflows.",
            "reusable": True,
            "intent": "Perform Playwright browser automation task.",
    ...
    try:
        ...
        for attempt in range(max(1, settings.GEMINI_RETRIES)):
            try:
                # ✅ Use SYNC Gemini call inside semaphore
