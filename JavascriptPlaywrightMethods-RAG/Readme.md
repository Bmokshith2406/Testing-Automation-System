...
This project is a production-grade backend platform for uploading, enriching, indexing, deduplicating, and semantically searching **Playwright JavaScript automation methods** using:
...
The platform ingests raw **JavaScript Playwright automation methods**, converts them into rich **MADL metadata**, computes embeddings, stores them in MongoDB, and enables highly-relevant semantic search with optional LLM reranking.
...
## Uploading Playwright JavaScript Methods
...
This column must contain **raw Playwright JavaScript automation function code**.
...
```json
{
  ...
  "keywords": ["login", "auth", "playwright"]
}
```
