...
class Settings:
    APP_NAME: str = "Intelligent Script Methods (MongoDB Edition for Playwright JavaScript Only)"
    VERSION: str = "1.0.0"
    ...
    DB_NAME: str = "javascript_playwright_script_methods_db"
    ...
    # ------------------------------------------------------------------
    # LLM Prompt Templates — Playwright JavaScript
    # ------------------------------------------------------------------

    Method_MADL_Prompt = """
    Analyze this raw Playwright JavaScript automation method and return STRICT JSON only with this schema:
    ...
    - method_name must contain full Playwright JavaScript function signature.
    - params must match JavaScript function parameters.
    - returns must be "Promise<void>" if nothing is returned.
    - keywords must relate to Playwright, JavaScript, Node.js automation, browser testing.
    ...
    This is a query that I have received from a user for Playwright JavaScript automation method searching.
    ...
    paraphrases and synonyms for Playwright JavaScript automation method search.
    ...
    Your task:
    Re-rank the following Playwright JavaScript automation methods based on how well each one matches the given query.
    ...
    Look at these Playwright JavaScript automation methods and choose the {top_k} that best match what the user really wants to automate.
    ...
    Analyze the following Playwright JavaScript automation method.
    ...
    You are an expert Playwright JavaScript automation method duplication detector.
